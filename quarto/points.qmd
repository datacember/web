...
Keep in mind, points are awarded sparsely, so don't be discouraged.
...
In addition to this, there is a novelty criteria that makes up to **2 points**. As per the namesake, novel submissions will be appreciated, and rewarded with additional points.

### Advent

You an also win points throughout the month by playing the advent calendar. Completing the advent calendar 7 days in a row will net you 4 points. 6 days 3, 5 days will give 2 and 4 days will give 1. The count resets each week.

### Bug Bounty

Find a substantial bug within the website or security vulnerability and win **1 point or 2 points** depending on the severity.
